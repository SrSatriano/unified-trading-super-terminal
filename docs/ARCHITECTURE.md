# Arquitetura — Unified Trading Super-Terminal

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

TUI de baixo consumo de RAM com kill switch, métricas de exposição e conectores configuráveis.
...
|------------|------------------|
| Layout | Layout multi-painel com refresh ~30 FPS |
| Kill | Kill switch e limites de exposição |
| Conector | Conector mock e base para REST Binance/Bybit |
| Credenciais | Credenciais via keyring ou variáveis de ambiente |
| Atalhos | Atalhos de teclado documentados |
