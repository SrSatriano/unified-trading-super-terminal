...
Obrigado por considerar uma contribuição para **Unified Trading Super-Terminal**.

## Como começar

1. Faça um fork do repositório [unified-trading-super-terminal](https://github.com/SrSatriano/unified-trading-super-terminal).
